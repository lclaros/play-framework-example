...
class LogEntryController @Inject() (repo: LogEntryRepository, val messagesApi: MessagesApi)
...
case class CreateLogEntryForm(name: String, president: Long, description: String, associationId: Long)

// Update required
case class UpdateLogEntryForm(id: Long, name: String, president: Long, description: String, associationId: Long)
