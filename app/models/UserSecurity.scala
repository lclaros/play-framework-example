...
class UserSecurity(val userName: String, val rolParam: String) extends Subject
{
  ...
  var rolesList: Map[String, List[SecurityRole]] = Map("admin" -> 
      List(
            ...
            new SecurityRole("association"), new SecurityRole("associationCreate"), new SecurityRole("associationList"), new SecurityRole("associationShow"), new SecurityRole("associationEdit"), new SecurityRole("associationDelete"),
